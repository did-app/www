...
If you have a question we have not answered here please do email it to us: [team@trykno.com](team@trykno.com)
...
<a name="can-kno-be-whitelabelled-on-my-website"></a>
### Can Kno be whitelabelled on my website?

The style and appearance of Kno on your website can be customised. Any customers on a [paid plan](https://trykno.com/#pricing) can also remove the 'Powered by Kno' link.

<a name="why-wouldnt-i-just-use-social-logins"></a>
### Why wouldn't I just use social logins?
Kno is more convenient to use than social login.  Users that do not have Facebook or Google accounts cannot use those social logins.  If the user does have an account with Facebook or Google they still need to log into it using an email address and password.
...
Kno offers a simple, secure solution that is easier to use than social logins and respects the user’s privacy.
...
As an additional security step you can remove authorisation for the lost or stolen device inside your Kno account (this feature is currently being developed).

<a name="what-happens-if-i-want-to-sell-my-device"></a>
### What happens if I want to sell my device?

Before you sell any device you would need to remove all of your personal data including any keys used by Kno to authenticate that device.

If you forget to remove all your data from the device when you sell it you can remove authorisation for that device inside your Kno account at any time (this feature is currently in development).
